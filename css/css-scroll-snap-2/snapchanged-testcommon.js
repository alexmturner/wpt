...
function assertSnapEvent(evt, expected_snap_target_ids) {
  ...
  assert_false(evt.cancellable, "snapchanged event is not cancellable.");
  assert_equals(evt.snappedList.x, expected_snap_target_ids.x.length,
                "snapchanged event has correct x target");
  assert_equals(evt.snappedList.y, expected_snap_target_ids.y.length,
